...
<head>
  ...
  <style>
    ...
    /* Custom class for word wrapping */
    .dt-wrap {
      /* column have same size width */
      width: 16.7%;
      /* word wrap */
      white-space: normal;
    ...
    <div class="container">
      ...
      <div class="row px-3">
        <div class="col-lg-6 d-flex justify-content-center justify-content-lg-end">
          <a href="#addProduct" data-toggle="modal" class="btn btn-edit align-self-center align-self-lg-end">Tambah
            Produk Baru</a>
        </div>
        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <td>
                <?php echo $row['kebutuhan_dana_nominal'] ?>
              </td>
              <td>
              ...
              <td>
                ...
                switch ($row['status']) {
                  ...
                  case 1:
                    ...
                    break;
                  case 2:
                    echo '<span style="color:grey">⌛ Dalam Proses</span>';
                    break;
                }
                ?>
              </td>
