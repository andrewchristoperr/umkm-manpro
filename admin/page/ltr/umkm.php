...
$sql = "SELECT * FROM umkmm WHERE id != 6 AND verification_status = 1";
                                    ...
                                    <tbody id="tbody-tablePendaftaran">
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><img src="../../../forms/<?php echo $data['foto_umkm'] ?>" alt="Card image cap" style="width: 300px; height: 200px;"></td>
                                                </tr>
